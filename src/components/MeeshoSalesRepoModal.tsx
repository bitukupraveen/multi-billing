...
interface MeeshoSalesRepoModalProps {
    isOpen: boolean;
    onClose: () => void;
    report: MeeshoSalesRepoRecord | null;
    onSave: (updatedReport: MeeshoSalesRepoRecord) => void;
    mode: 'view' | 'edit';
}

const MeeshoSalesRepoModal: React.FC<MeeshoSalesRepoModalProps> = ({ isOpen, onClose, report, onSave, mode }) => {
    const [formData, setFormData] = useState<MeeshoSalesRepoRecord | null>(null);
    ...
    const handleInputChange = (field: keyof MeeshoSalesRepoRecord, value: any) => {
        if (!formData) return;
    ...
    const renderInput = (label: string, field: keyof MeeshoSalesRepoRecord, type: string = 'text', prefix: string = '') => (
        <div className="mb-3">
                ...
                <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '15px' }}>
                    <div className="modal-header bg-white border-bottom-0 p-4">
                        <div className="d-flex align-items-center gap-2">
                            ...
                            <h5 className="modal-title fw-bold">
                                {mode === 'view' ? 'View Meesho Sales Record' : 'Edit Meesho Sales Record'}
                            </h5>
                        </div>
                    ...
                    <div className="modal-body p-4 bg-light-subtle">
                        <div className="row">
                            ...
                            {/* Order Details */}
                            <div className="col-12"><SectionTitle title="Order & Product Details" /></div>
...
export default MeeshoSalesRepoModal;
