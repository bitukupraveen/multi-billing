...
import MeeshoSalesReturnModal from '../components/MeeshoSalesReturnModal';

const MeeshoSalesReturn: React.FC = () => {
    const { data: savedReports, add, update, remove, loading: firestoreLoading } = useFirestore<MeeshoSalesReturnRecord>('meeshoSalesReturnReports');
    ...
    const [selectedReport, setSelectedReport] = useState<MeeshoSalesReturnRecord | null>(null);
    ...
    const handleSaveToFirebase = async () => {
        ...
        try {
            ...
            for (const row of parsedData) {
                ...
                const report: Omit<MeeshoSalesReturnRecord, 'id'> = {
                    ...
                    cancelReturnDate: getVal(['cancel_return_date', 'return_date'])?.toString(),
    ...
    const handleViewReport = (report: MeeshoSalesReturnRecord) => {
        setSelectedReport(report);
        setModalMode('view');
        setModalOpen(true);
    };

    const handleEditReport = (report: MeeshoSalesReturnRecord) => {
        setSelectedReport(report);
        setModalMode('edit');
        setModalOpen(true);
    };

    const handleSaveReport = async (updatedReport: MeeshoSalesReturnRecord) => {
    ...
    const handleExportExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Meesho Sales Return Report");
        XLSX.writeFile(wb, `Meesho_Sales_Return_Report_${new Date().toISOString().split('T')[0]}.xlsx`);
    };
    ...
    return (
        <div className="container-fluid py-4">
            <div className="d-flex justify-content-between align-items-center mb-4">
                <h2 className="h3 mb-0 fw-bold text-gray-800">Meesho Sales Return Report</h2>
                ...
                <div className="col-md-4">
                    <div className="card border-0 shadow-sm bg-primary text-white overflow-hidden">
                        <div className="card-body p-4 position-relative">
                            ...
                            <h6 className="text-uppercase small fw-bold opacity-75 mb-3">Total Return Invoice Value</h6>
                ...
                <div className="card-body p-4">
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <label className="d-block mb-3 fw-medium text-secondary">Upload Meesho Sales Return Excel</label>
            ...
            <div className="card border-0 shadow-sm">
                <div className="card-header bg-white py-3 border-0">
                    <div className="row align-items-center">
                        <div className="col">
                            <h5 className="mb-0 fw-bold">Saved Meesho Sales Return Records</h5>
                        </div>
                        <div className="col-md-4">
                            ...
                            {firestoreLoading ? (
                                ...
                                paginatedReports.map((report) => (
                                    <tr key={report.id}>
                                        ...
                                        <td>
                                            <div className="small">{report.cancelReturnDate}</div>
                                            <div className="small text-secondary">Ordered: {report.orderDate}</div>
                                        </td>
...
export default MeeshoSalesReturn;
